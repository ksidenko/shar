function gallery_init() {
    $(document).ready(function(){ 
        var galleries = $('.ad-gallery').adGallery({
          ...
          //width: 995, // Width of the image, set to false and it will read the CSS width
          ...
          callbacks: {
            ...
            beforeImageVisible: function(new_image, old_image) {
              var zoom = $('.ad-image').append('<span class="zoom"></span>');
//                zoom.click(function(e){
//                        var e = jQuery.Event("click");
//                        e.target = $('.ad-image-wrapper .ad-image img');
//                        $('.ad-image-wrapper').trigger( e );
//                        return false;
//                });
              // Do something wild!
            }
