...
<img src="<?php echo Yii::app()->request->baseUrl . "/images/$lang/pathway.jpg"; ?>" height="460" class="g-fleft" style="padding: 0px">
    <div class="g-fleft contacts-block">
        <H1>Shemonaev<br>Andrey Rudolfovich</H1>
        <p>Novosibirsk</p>
        <p>Galushaka st, 2 - 110</p>
        <p>office: (383) 246 01 95</p>
        <p>mob.: 8 913 924 71 70</p>
        <p>e-mail: sharsd@yandex.ru</p>
    </div>

    <div class="g-fleft contacts-block">
        <H1>Shemonaeva<br>Irinа Vasilyavna</H1>
        <p>Novosibirsk</p>
        <p>Galushaka st, 2 - 110</p>
        <p>office: (383) 246 01 95</p>
        <p>mob.: 8 913 919 46 02</p>
        <p>e-mail: sharsd@yandex.ru</p>
    </div>
